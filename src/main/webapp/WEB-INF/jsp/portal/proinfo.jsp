  ...
  <div class="cont">
   ...
   <div id="tsShopContainer">
    ...
    <div class="proBoxRight">
     <h3 class="proTitle">三只松鼠 饮料杯 250ml 41121 50个/袋</h3>
     <div>商品编号： 334011 </div>
     ...
     <div class="gc">
      <a href="order.html"><img src="images/goumai.png" width="1三只松鼠"  height="36" /></a>&nbsp;&nbsp;
      <a href="#"><img src="images/shoucang.png" width="1三只松鼠" height="36" /></a>
     </div><!--gc/-->    
    </div><!--proRight/-->
    <div class="clears"></div>
    </div><!--proBox/-->
