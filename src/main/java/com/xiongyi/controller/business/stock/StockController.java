package com.xiongyi.controller.business.stock;
...
import com.xiongyi.service.business.stock.StockManager;
...
public class StockController extends BaseController {
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("INVENTORYNUM"));	//2
			varList.add(vpd);
		}
